...
## entrada e saída para o código
binary_i = np.array([[0,0], [0,1], [1,0], [1,1]])
binary_o = np.array([[0], [1], [1], [0]])

## criação de dois tensors que serão alimentados durante o treino
...
logits = tf.layers.dense(hidden1, n_outputs, name="outputs_new")

## definindo algoritmo que será usado
eta = 0.1
n_epochs = 500
